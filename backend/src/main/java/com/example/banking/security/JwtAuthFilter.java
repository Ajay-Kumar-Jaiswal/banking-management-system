 ...
 * @PreAuthorize / hasRole checks and controller-level `Authentication` work.
 */
@Component
...
public class JwtAuthFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(@NonNull HttpServletRequest request,
        ...
        try {
            ...
            // The request will be rejected downstream by Spring Security
            // as unauthenticated (401) for any protected endpoint.
        }
