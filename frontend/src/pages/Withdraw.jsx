...
export default function Withdraw() {
  ...
  const handleSubmit = async (e) => {
    ...
    setSubmitting(true);
    try {
      const res = await withdraw({ accountId: Number(accountId), amount: Number(amount), description });
      setSuccess(`Withdrawal successful. New balance: ${formatCurrency(res.data.balanceAfter)}`);
      setAmount("");
      setDescription("");
    } catch (err) {
